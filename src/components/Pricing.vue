  ...
  <div class="bg-blue-900">
    <div class="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
      <div class="text-center">
        ...
        <p class="mt-3 max-w-4xl mx-auto text-xl text-gray-300 sm:mt-5 sm:text-2xl">
          Ist es Dein Ziel unglaublich akrobatische Übungen in einem atemberaubenden Tempo auszuführen, oder möchtest Du einen schmerzfreien, gesunden Körper, der Dich im Alltag nicht im Stich lässt. Jeder bekommt von Pilates so viel zurück, wie er hineinsteckt.
        </p>
      </div>
    </div>
    ...
    <div class="mt-16 bg-white pb-12 lg:mt-20 lg:pb-20">
      <div class="relative z-0">
        <div class="absolute inset-0 h-5/6 bg-blue-900 lg:h-2/3" />
          ...
          <div class="relative lg:grid lg:grid-cols-7">
                  ...
                  <div class="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                    ...
                    <div class="mt-8">
                      <div class="rounded-lg shadow-md">
                        <a
                          href="#"
                          class="block w-full text-center rounded-lg border border-transparent bg-white px-6 py-3 text-base font-medium text-blue-600 hover:bg-gray-50"
            ...
            <div class="mt-10 max-w-lg mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4">
              <div class="relative z-10 rounded-lg shadow-xl">
                <div
                  class="pointer-events-none absolute inset-0 rounded-lg border-2 border-blue-600"
                  aria-hidden="true"
                />
                ...
                <div class="border-t-2 border-gray-100 rounded-b-lg pt-10 pb-8 px-6 bg-gray-50 sm:px-10 sm:py-10">
                  ...
                  <div class="mt-10">
                    <div class="rounded-lg shadow-md">
                      <a
                        href="#"
                        class="block w-full text-center rounded-lg border border-transparent bg-blue-600 px-6 py-4 text-xl leading-6 font-medium text-white hover:bg-blue-700"
